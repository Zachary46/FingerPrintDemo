package csii.cjs.demo.com.fingerprintdemo.dialog;
...
import csii.cjs.demo.com.fingerprintdemo.R;
import csii.cjs.demo.com.fingerprintdemo.base.ContextUtil;
import csii.cjs.demo.com.fingerprintdemo.base.FingerPrintHelper;
import csii.cjs.demo.com.fingerprintdemo.tools.ColorUtil;
import csii.cjs.demo.com.fingerprintdemo.tools.DrawableUtil;
...
public class FingerPrintDialog extends AbstractDialogFragment implements View.OnClickListener{
    ...
    private void setStyle(String msg, int style){
        ...
        switch (style){
            case STYLE_ERROR:
                tv_desc.setTextColor(ColorUtil.getColorSrc(COLOR_ERROR));
                DrawableUtil.setDrawableTintColor(iv_icon_finger.getDrawable(),COLOR_ERROR);
                break;
            case STYLE_WARN:
                tv_desc.setTextColor(ColorUtil.getColorSrc(COLOR_WARN));
                DrawableUtil.removeDrawableTintColor(iv_icon_finger.getDrawable());
                break;
            case STYLE_SUCCESS:
                tv_desc.setTextColor(ColorUtil.getColorSrc(COLOR_SUCCESS));
                DrawableUtil.setDrawableTintColor(iv_icon_finger.getDrawable(),COLOR_SUCCESS);
                mProgressBar.setVisibility(View.GONE);
                break;
            default:
                tv_desc.setTextColor(ColorUtil.getColorSrc(R.color.white_gray));
                DrawableUtil.removeDrawableTintColor(iv_icon_finger.getDrawable());
                break;
